...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_project_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['projects.project'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('projects_project_groups', ['project_id', 'group_id'])


    def backwards(self, orm):
        # Removing M2M table for field groups on 'Project'
        db.delete_table('projects_project_groups')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projects_groups'", 'symmetrical': 'False', 'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
